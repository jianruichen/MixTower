...
class OptimizerWrapper(object):
    # A Wrapper for optimizer to support learning rate warmup and decay. It also support multiple optimizers.
...
def get_optim(__C, model):
    ...
    return OptimizerWrapper([optim_class(params, **hyper_params),], warmup_schd_steps=__C.WARMUP_EPOCH, decay_schd_step_list=__C.LR_DECAY_LIST, decay_rate=__C.LR_DECAY_R,)
...
def get_optim_for_finetune(__C, model, new_params_name='proj1'):
    ...
    optimizer1 = optim_class1(params1, lr=__C.LR_BASE_FTW, **hyper_params1)
    ...
    return OptimizerWrapper([optimizer1, optimizer2], warmup_schd_steps=__C.WARMUP_EPOCH, decay_schd_step_list=__C.LR_DECAY_LIST, decay_rate=__C.LR_DECAY_R, change_optim_step_list=[__C.EPOPH_FTW,])
