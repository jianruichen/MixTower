...
class PATH:
    def __init__(self):
        ...
        # ## image path
        self.IMAGE_DIR = {
            'train2014': 'F:/BIGDATA/VQA2' + '/train2014/',
            'val2014': 'F:/BIGDATA/VQA2' + '/val2014/',
        }

        # ## image features path
        self.FEATS_DIR = {
            'train2014': '/home/jiaminli/code/BIGDATA/VQA2_feats' + '/train2014/',
            'val2014': '/home/jiaminli/code/BIGDATA/VQA2_feats' + '/val2014/',
        }
        ...
        self.QUESTION_PATH = {
            ...
            'cocotrain': self.DATASET_ROOT + 'coco/coco_train_questions.json',
            'cocotest': self.DATASET_ROOT + 'coco/coco_test_questions.json',
        }
        ...
        self.ANSWER_PATH = {
            ...
            'cocotrain': self.DATASET_ROOT + 'coco/coco_train_annotations.json',
            'cocotest': self.DATASET_ROOT + 'coco/coco_test_annotations.json',
        }
        ...
        self.ANSWER_DICT_PATH = {
            ...
            'coco': self.ASSETS_ROOT + 'answer_dict_coco.json',
        }
